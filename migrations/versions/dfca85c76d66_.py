...
Revision ID: dfca85c76d66
Revises: 369172df25f0
Create Date: 2023-03-03 18:49:43.309070
...
revision = 'dfca85c76d66'
down_revision = '369172df25f0'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('card', schema=None) as batch_op:
        batch_op.add_column(sa.Column('media_type', sa.String(length=1000), server_default='Unknown', nullable=False))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('card', schema=None) as batch_op:
        batch_op.add_column(sa.Column('type', sa.VARCHAR(length=1000), nullable=True))
