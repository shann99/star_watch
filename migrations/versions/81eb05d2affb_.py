...
Revision ID: 81eb05d2affb
Revises: e4a5abfff3d7
Create Date: 2023-03-03 18:46:18.376009
...
revision = '81eb05d2affb'
down_revision = 'e4a5abfff3d7'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('card', schema=None) as batch_op:
        batch_op.add_column(sa.Column('language', sa.String(length=1000), server_default='Unknown', nullable=False))
